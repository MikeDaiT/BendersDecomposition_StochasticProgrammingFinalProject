...
fprintf('Setting PV volume %dMW\n',k*A_PV_v/1000 );
fprintf('Setting H2 generation volume %d/MW\n',E_EL_S_v/1000 );
fprintf('Setting CH4 generation volume %d/MW\n',E_CH4_S_v/1000 );
fprintf('Setting H2 storage volume %d/N.m3\n',V_H2_S_v );
fprintf('Setting CO2 storage volume %d/N.m3\n',V_CO2_S_v );
